// Add this part in your existing JavaScript
fetchData("preguntarIngles", (data) => {
    ...
    niveles.forEach((nivel, index) => {
      ...
      divElement.innerHTML = `
        <div id="boton-nivel-${index}" class="boton-nivel">${nivel}</div>
  ...
  // Function to enlarge the button and hide the "franja"
  function agrandarBoton(id) {
    var botonConFranja = document.getElementById(id);
    var boton = botonConFranja.querySelector(".boton-nivel");
