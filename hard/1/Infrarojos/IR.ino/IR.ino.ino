...
void loop() {
  ...
  detenerMotor(EN2);
  detenerMotor(EN1);
  retrocederMotor1(velocidadCorreccion); //Enciendo el motor izquierdo para
  ...
  Serial.print("corrigiendo motor otro, tiempo retoseso ");
  detenerMotor(EN1);
  tiempoRetroceso = millis() - tiempoAnterior;
  Serial.print(tiempoRetroceso);
  Serial.print(" tiempo Avance ");
